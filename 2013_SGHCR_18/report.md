...
21     In _Wong Meng Cheong and another v Ling Ai Wah and another_ <span style="background-color: #FAC0C0">[[2012] 1 SLR 549]("https://www.open.gov.sg")</span>, Justice Lai Siu Chiu held that the statutory test under the MCA on mental capacity was consistent with common law definitions. She observed, at [27], that: 
...
39     In _Wong Foong Chai v Lin Kuo Hao_ <span style="background-color: #FAC0C0">[[2005] 3 SLR(R) 74]("https://www.open.gov.sg")</span> [“ _Wong Foong Chai_ ”], Judicial Commissioner Andrew Phang (as he then was) made the following observations on the rationale of the MVA, at [42]: 
