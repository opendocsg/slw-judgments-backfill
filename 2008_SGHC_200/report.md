...
43     I address next the third defendant’s argument in relation to Practice Direction 2007 Rule 41 (“the Rule”) on _ex parte_ applications for injunctions. The Rule states: 
 ...
 (1) Order 29, Rule 1 of the Rules of Court provides that an application for the grant of an injunction may be made ex parte in cases of urgency. However, the cases of Castle Fitness Consultancy Pte Ltd v Manz [1989] SLR 896 and The Nagasaki (No. 1) <span class="citation">[1994] 1 SLR 434</span> take the position that an opponent to an ex parte application, especially where the application seeks injunctive relief, should be invited to attend at the hearing of the application. 
