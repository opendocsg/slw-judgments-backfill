...
45     Furthermore, an oral collateral contract, distinct from the principal contract, must satisfy all the usual legal requirements of a contract, including the following: 
 ...
 (a) The statement must be promissory in nature or effect rather than representational ( Lemon Grass v Peranakan Place Complex Pte Ltd <span style="background-color: #FAC0C0" class="citation">[[2002] 2 SLR(R) 50]("https://www.open.gov.sg")</span> (“ Lemon grass ”) at [116]–[117]). 
