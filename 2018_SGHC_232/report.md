...
39     I first set out the general principles regarding repudiatory breach before turning to the individual breaches alleged by the first defendant. It is well-established that a repudiatory breach arises in the following scenarios: 
 ...
 (a) First, “where the contract clearly and unambiguously states that, in the event of a certain event or events occurring, the innocent party will be entitled to terminate the contract” ( RDC Concrete Pte Ltd v Sato Kogyo (S) Pte Ltd <span style="background-color: #FAC0C0" class="citation">[[2007] 4 SLR(R) 413]("https://www.open.gov.sg")</span> (“ RDC Concrete ”) at [91]). This was described in RDC Concrete as “Situation 1”. 
...
147    The parties do not dispute the legal principles relating to misrepresentation. The elements are satisfied when a party relies on a false representation in entering into the contract with the representor ( _Straits Colonies Pte Ltd v SMRT Alpha Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2018] 2 SLR 441]("https://www.open.gov.sg")</span> at [33]). 
