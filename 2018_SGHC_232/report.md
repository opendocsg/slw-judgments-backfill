<span style="background-color: #FAC0C0"># Royal Melbourne Institute of Technology v Stansfield College Pte Ltd and another 
...
39     I first set out the general principles regarding repudiatory breach before turning to the individual breaches alleged by the first defendant. It is well-established that a repudiatory breach arises in the following scenarios: 
 ...
 (a) First, “where the contract clearly and unambiguously states that, in the event of a certain event or events occurring, the innocent party will be entitled to terminate the contract” ( RDC Concrete Pte Ltd v Sato Kogyo (S) Pte Ltd [[2007] 4 SLR(R) 413]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ RDC Concrete ”) at [91]). This was described in RDC Concrete as “Situation 1”. 
