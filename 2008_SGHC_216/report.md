...
11     The appellant’s submission was that the proper order of costs should be that each party pay its own costs for the following reasons: 
 ...
 (b) The OTS should be disregarded as it was ambiguous in that it referred only to the claim and not the counterclaim (citing SBS Transit Ltd v Teo Chye Seng Douglas <span style="background-color: #FAC0C0">[[2005] SGHC 15]("https://www.open.gov.sg")</span>). 
...
13     The Judge made the following findings: 
 ...
 (c) The judgment sum was more favourable than the OTS even though the amount in excess was only $8.96 (see Singapore Airlines Ltd v Tan Shwu Leng <span style="background-color: #FAC0C0">[[2001] 4 SLR 593]("https://www.open.gov.sg")</span> (“ Singapore Airlines Ltd ”) at [4]). 
