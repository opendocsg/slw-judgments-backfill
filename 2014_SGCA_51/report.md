...
19     The definition of “corrupt” was considered for the first time in _Chan Wing Seng v Public Prosecutor_ <span style="background-color: #FAC0C0">[[1997] 1 SLR(R) 721]("https://www.open.gov.sg")</span> (“ _Chan Wing Seng_ ”) by Yong Pung How CJ in the following manner (at [26]–[27]): 
...
20     The elements of an offence under s 6( _a_ ) (where the agent has already obtained the gift) are set out in _Kwang Boon Keong Peter v Public Prosecutor_ <span style="background-color: #FAC0C0">[[1998] 2 SLR(R) 211]("https://www.open.gov.sg")</span> (“ _Peter Kwang_ ”) at [32] as follows: 
