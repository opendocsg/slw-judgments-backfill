<span style="background-color: #FAC0C0"># ARV v ARW 
...
a presumption against the Husband of both the sc ope of the matrimonial pool and its value. In _Koh Bee Choo v Choo Chai Huah_ [[2007] SGCA 21]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, the Court of Appeal noted (at [27]) that for an adverse inferenc e to be drawn, there should be: 
...
61     In prac tic al terms, the c onsequenc e that follows is that the c ourt may give a higher proportion of known assets where full disc losure has not been given. A broad-brush approac h giving an additional uplift to represent the undisc losed assets is permissible: _Yeo Chong Lin v Tay Ang Choo Nancy and another appeal_ [[2011] 2 SLR 1157]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [66]. That c ase however also rec ognised that a higher proportion of the known assets may be given to c ompensate for the failure to disc lose. This was done in _NK v NL_. 
