...
41     I find it difficult to accept the accused’s explanation that he did not want to implicate Gobi. The failure to mention Gobi is a significant omission in the version of events described by the accused in his cautioned statement. There is no reason why the accused could have left out a character as important as Gobi in its entirety in his cautioned statement. Such an important omission causes me to disbelieve the accused’s version of events regarding Kumar and Gobi: see _Govindarajulu Murali and another v Public Prosecutor_ <span style="background-color: #FAC0C0" class="citation">[[1994] 2 SLR(R) 398]("https://www.open.gov.sg")</span> at [32]–[33]. 
