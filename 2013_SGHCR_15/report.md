<span style="background-color: #FAC0C0"># Boey Chun Hian (by his guardian and next friend, Boey Ghim Huat) v Singapore Sports 
...
15     Regardless of the differences between these two forms of privilege, it is trite that it is for the party asserting privilege and refusing disclosure to prove that he is entitled to the privilege ( _Brink’s Inc v Singapore Airlines Ltd_ [[1998] SGCA 33]("https://www.open.gov.sg")</span> applying _Waugh v British Railways Board_ [1980] AC 521 
