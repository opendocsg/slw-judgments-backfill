...
20     This appears to be the position taken by the cases that have discussed s 199 of the CA. In _Wuu Khek Chiang George v ECRC Land Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[1999] 2 SLR(R) 352]("https://www.open.gov.sg")</span> (“ _Wuu’s_ case”) at [26], it was held by the Court of Appeal that a director’s right to inspect the accounting and other records of the company under s 199(3) is an absolute one: 
...
25     Furthermore the purpose of the right to inspect was given a wide interpretation. In _Hau Tau Khang v Sanur Indonesian Restaurant Pte Ltd and another (Hau Tau Thong, non-party) and another matter_ <span style="background-color: #FAC0C0" class="citation">[[2011] 3 SLR 1128]("https://www.open.gov.sg")</span> (“ _Sanur Restaurant_ ”), Steven Chong J held at [22]–[23] that: 
