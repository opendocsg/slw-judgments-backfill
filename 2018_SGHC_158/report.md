...
125    The Plaintiff also relied on this court’s decision in _Tey Tsun Hang v Public Prosecutor_ <span style="background-color: #FAC0C0" class="citation">[[2014] 2 SLR 1189]("https://www.open.gov.sg")</span> at [208] where this court held that NUS is a public body for the purpose of the Prevention of Corruption Act (Cap 241, 1993 Rev Ed) (“PCA”). However, it is quite clear that that finding was for the purpose of PCA only and it did not mean that NUS is a public body in all respects and circumstances. The present dispute between the Plaintiff and NUS arises from the contract between them as set out above. 
