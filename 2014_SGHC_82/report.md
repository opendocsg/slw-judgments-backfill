<span style="background-color: #FAC0C0"># Lawrence Khong Kin Hoong v Singapore Polo Club 
...
26     Natural justice involves a duty to act fairly which encompasses a duty to act impartially: _Kay Swee Pin_ at [6] and [7]. This requires that “the tribunal tasked with determining the dispute shall be disinterested and independent”: _Re Shankar Alan s/o Anant Kulkarni_ [[2007] 1 SLR(R) 85]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Shankar_ ”) at [42]. This encompasses both the rules against actual and apparent bias. The Plaintiff’s contention was that the Defendant had breached the rule against apparent bias. 
