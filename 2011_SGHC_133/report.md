...
side” rule, which is the fair hearing rule (see _Yong Vui Kong v Attorney-General_ [[2011] SGCA 9]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [88]). 
...
43     The Court of Appeal in _Tan Tiang Hin Jerry v Singapore Medical Council_ [[2000] 1 SLR(R) 553]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Tan Tiang Hin Jerry_ ”) adopted (at [47]) the following approach in determining whether a statutory requirement is to be regarded as mandatory or directory (citing S A de Smith, _Judicial Review of_ 
...
suspicions of the person affected. The legal test is an objective one: whether there are circumstances which would give rise to a reasonable suspicion or apprehension in a fair-minded reasonable person with knowledge of the relevant facts that the tribunal was biased (see _Re Shankar Alan s/o Anant Kulkarni_ [[2007] 1 SLR(R) 85]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [91]). The circumstances must objectively be well founded and of sufficient gravity. The standard varies depending on whether the decision is an administrative decision and whether the decision is the result of a fact-finding process (see [25]–[26] above and [53] below). 

53     The court will have regard to the context in which bias is raised (see _Lionel James De Souza v Attorney-General_ [[1992] 3 SLR(R) 552]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [31]): 
