...
49     In cases such as the present one, where parties carry on negotiations with a view to conclude a contract, “the courts look at the whole course of the negotiations between both parties in order to ascertain if an agreement is reached at any given point in time”: _Gay Choon Ing v Loh Sze Ti Terence Peter_ <span style="background-color: #FAC0C0">[[2009] 2 SLR(R) 332]("https://www.open.gov.sg")</span> at [53]. 
