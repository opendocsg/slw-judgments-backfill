...
5       The defendants to the Singapore proceedings have in fact previously commenced an action against the plaintiffs in OS No. 179 of 2004/J (“OS 179”). I gratefully adopt the facts as set out in the High Court judgment (see <span class="citation">[2005] SGHC 174</span>) below as it best summarise the facts that lead to the present application for a stay of the Singapore proceedings. 
...
44     This decision in _Win Line_ was recently affirmed by Sundaresh Menon JC in _Public Prosecutor v Lew Syn Pau and another_ <span class="citation">[2006] 4 SLR 210</span>. The court reiterated the principle that companies in a group remain separate legal entities. This is so even when a holding company in effect exercises 
