...
_v PP_ <span style="background-color: #FAC0C0">[[1995] 1 SLR(R) 185]("https://www.open.gov.sg")</span> at [15]). [note: 25] Parenthetically, we doubt whether a CBT offence can even be made out on the present facts given that there is no entrustment of any property. 
...
74     The oft-cited pronouncement on the scope and effect of the parity principle as it applies in Singapore is found in _Public Prosecutor v Ramlee_ <span style="background-color: #FAC0C0">[[1998] 3 SLR(R) 95]("https://www.open.gov.sg")</span>. In that case Yong Pung How CJ stated at [7]: 
