<span style="background-color: #FAC0C0"># Cheung Kam Yi Betty v Liu Tsun Kie 
...
73     To obtain the multiplier for the lump sum maintenance, the wife relied on the recent decision of _Wan Lai Cheng v Quek Seow Kee and another appeal and another matter_ [[2012] SGCA 40]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Wan Lai Cheng_ ”), where the Court of Appeal in dealing with this issue accepted the method of calculating the multiplier set out in _Ong Chen Leng v Tan Sau Poo_ [[1993] 2 SLR(R) 545]("https://www.open.gov.sg")</span> which as set out at [35] thereof was: 
