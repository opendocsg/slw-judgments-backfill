...
21     Secondly, the law is clear. Even in cases where an application for _mandamus_ or a mandatory order has been made, ( _ie_ , the applicants have already obtained leave under O 53), the Courts have been slow in granting such an order against the police: see _Anwar Siraj and Another v Ting Kang Chung John_ <span style="background-color: #FAC0C0">[[2009] SGCA 61]("https://www.open.gov.sg")</span> at [40]-[41], where the Court of Appeal cited with approval Clive Lewis 
