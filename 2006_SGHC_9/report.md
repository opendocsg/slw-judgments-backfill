...
76     The Prosecution is not obliged to supply or prove a precise motive before a person is convicted of culpable homicide: _Lau Lee Peng v PP_ <span style="background-color: #FAC0C0">[[2000] 2 SLR 628]("https://www.open.gov.sg")</span>. The Court of Appeal declared in that case, at [43], that the only burden on the Prosecution is to show that the accused intended to inflict the injuries caused: 
