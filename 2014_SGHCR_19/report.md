...
37     The burden ultimately falls on the Plaintiffs to show the Court that there is good reason for the extension of time to be granted. In _The Lircay_ <span style="background-color: #FAC0C0">[[1997] 1 SLR(R) 699]("https://www.open.gov.sg")</span>, a case which concerned the extension of the validity of an admiralty writ, the Court held that at [18] that: 
