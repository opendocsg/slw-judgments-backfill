<span style="background-color: #FAC0C0"># Hyundai Engineering and Construction Co Ltd v Sembawang Kimtrans (S) Pte Ltd 
...
Section 28 of the Arbitration Act is intended to promote greater finality in arbitration awards. In cases such as this, where the clauses to be interpreted are `one-off` clauses, it would be appropriate to note that in **American Home Assurance Co v Hong Lam Marine Pte Ltd** [[1999] 3 SLR 682]("https://www.open.gov.sg")</span> Yong Pung How CJ summed up the position when he said as follows: 
