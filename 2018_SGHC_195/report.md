...
125    The plaintiffs’ closing submissions (at paras 99 to 105) pointed out that Article 7 itself does not prohibit a trust or make it invalid. It merely states that KK Asia shall not be bound to recognise a trust. The plaintiff added that a valid trust may be formed so long as the intention of the settlor to create the trust is certain, the identity of the trust property is certain and the identity of the beneficiaries is defined with some precision (citing the appellate court’s decision in _Guy Neale v Nine Squares Pty Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2015] 1 SLR 1097]("https://www.open.gov.sg")</span> at [51]). Here, Domenico had expressly declared he held the shares in KK Asia on trust for RGA. 
