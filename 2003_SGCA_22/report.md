...
28     As counsel for the appellant rightly conceded, the burden was on the defence to show, on a balance of probabilities, that the accused was so intoxicated that he could not have formed the necessary intention to commit the offence he was charged with: see _Suradet v PP_ <span style="background-color: #FAC0C0" class="citation">[[1993] 3 SLR 265]("https://www.open.gov.sg")</span> and _Indra Wijaya Ibrahim v PP_ <span style="background-color: #FAC0C0" class="citation">[[1995] 2 SLR 442]("https://www.open.gov.sg")</span>. 
