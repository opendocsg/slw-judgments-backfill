...
[note: 1] (^) _Public Prosec utor v Praveen s/o Krishnan_ <span style="background-color: #FAC0C0">[[2017] SGDC 190]("https://www.open.gov.sg")</span> at [11] [note: 2] (^) ROP p 37 [note: 3] (^) ROP p 282 para 7.1 (first probation report) [note: 4] (^) ROP p 259 [note: 5] (^) ROP p 41 [note: 6] (^) ROP p 41 [note: 7] (^) ROP pp 41–43 
