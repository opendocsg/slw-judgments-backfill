...
24     Phang J went on to decide on the merits of the application. He started by identifying the standard of proof to be satisfied to obtain leave. He referred to _Chan Hiang Leng Colin v Minister for Information and the Arts_ <span style="background-color: #FAC0C0" class="citation">[[1996] 1 SLR 609]("https://www.open.gov.sg")</span> (“ _Colin Chan_ ’s case”), and concluded that there was a very low threshold for an applicant to meet. 
