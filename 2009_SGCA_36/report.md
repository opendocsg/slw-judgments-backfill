...
the issue(s) pleaded by the parties. He referred to principles established by case law, such as _Ong Seow Pheng v Lotus Development Corp_ <span style="background-color: #FAC0C0" class="citation">[[1997] 3 SLR 137]("https://www.open.gov.sg")</span> and _The Ohm Mariana_ <span style="background-color: #FAC0C0" class="citation">[[1993] 2 SLR 698]("https://www.open.gov.sg")</span>. Counsel for the respondent, on the other hand, relied on cases such as _PT Tenar Indoam Oil Services v Third Wave Group Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2008] SGHC 18]("https://www.open.gov.sg")</span> in support of the contention that there is no absolute rule prohibiting a court from making findings of fact outside of the pleadings. 
