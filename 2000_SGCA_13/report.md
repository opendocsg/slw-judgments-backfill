<span style="background-color: #FAC0C0"># Lau Lee Peng v Public Prosecutor 
...
How Exception I should be interpreted and applied was recently considered by this court in **PP v Kwan Cin Cheng** [[1998] 2 SLR 345]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> where it held (at p 355): 
...
must be established. If the intention to kill is proved to exist, however sudden such an intention was formed, that would amount to murder: see **Shaiful Edham bin Adam v PP** [[1999] 2 SLR 57]("https://www.open.gov.sg")</span>. In this case the appellant did in fact kill the deceased. 
