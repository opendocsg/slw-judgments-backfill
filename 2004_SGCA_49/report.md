<span style="background-color: #FAC0C0"># Velstra Pte Ltd v Dexia Bank NV 
...
23     Admittedly, as would be seen from s 98(3) quoted above (at [13]), a gift is also a transaction within the meaning of s 98(1). In the context here, a gift is perhaps an express statutory exception to the mutuality rule. We had in _Mercator & Noordstar NV v Velstra Pte Ltd_ [[2003] 4 SLR 667]("https://www.open.gov.sg")</span> (“ _Mercator_ ”) opined ( _obiter_ ) at [24] that a gift is a unilateral act. There is controversy, as a matter of jurisprudence, whether a gift is a one-sided act or a two-sided consensual act. Is the donee’s acceptance an essential part of the law of gift? It would seem that no single theory can apply to all situations where a gift arises. 
