<span style="background-color: #FAC0C0"># Dynasty Line Ltd (in liquidation) v Sukamto Sia and another and another appeal 
...
82     In _Denis Matthew Harte v Tan Hun Hoe and Another_ [[2001] SGHC 19]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, Chan Seng Onn JC (as he then was) explained the rationale of O 22A r 10 and why compliance had to be strict, and he stated that the costs consequences under O 22A r 9 cannot apply and the court should be slow to mimic the costs consequences when exercising its general discretion: 
