...
I added at [50] that while “merely neglecting to make inquiries which a reasonable and prudent man would make” did not constitute guilty knowledge (see also _PP v Koo Pui Fong_ <span style="background-color: #FAC0C0" class="citation">[[1996] 2 SLR 266]("https://www.open.gov.sg")</span> at 272, [22]): 
...
What the trial court must do in such cases is to make a finding that the evidence of the sole witness in question was “so compelling that a conviction could be based solely on it”: _Tan Wei Yi v PP_ <span style="background-color: #FAC0C0" class="citation">[[2005] 3 SLR 471]("https://www.open.gov.sg")</span> (“ _Tan Wei Yi_ ”) at [23]. 
