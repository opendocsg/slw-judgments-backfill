...
17     An allegation that a doctor was negligent in failing to order a post-operative diagnostic test must be positively proved, and the medical basis for ordering the test must be affirmatively established. A doctor would not be negligent simply because there was no harm in ordering the test ( _Chua Thong Jiang Andrew v Yue Wai Mun and another_ <span style="background-color: #FAC0C0" class="citation">[[2015] SGHC 119]("https://www.open.gov.sg")</span> at [66]–[69]). 
...
163    Even if there was a negligent omission, no liability lies unless the negligence _caused_ or _materially contributed_ to the injuries suffered ( _Yeo Peng Hock Henry v Pai Lily_ <span style="background-color: #FAC0C0" class="citation">[[2001] 3 SLR(R) 555]("https://www.open.gov.sg")</span> at [52]). 
