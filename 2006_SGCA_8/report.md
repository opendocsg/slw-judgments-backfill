...
1       This was an appeal against the decision of Lai Kew Chai J (reported at <span style="background-color: #FAC0C0" class="citation">[[2005] 4 SLR 367]("https://www.open.gov.sg")</span>) who dismissed the appellant’s appeal against the decision of the assistant registrar setting aside the statutory demands issued by the appellant to the respondent and the respondent’s son, under s 62 of the Bankruptcy Act (Cap 20, 2000 Rev Ed) (“s 62”). We heard the appeal on 26 January 2006 and dismissed it. 
