...
50     The plaintiff’s pleaded case is that the November Agreement was not supported by consideration. In support of this point the plaintiff referred to _Essen System Builders (S) Pte Ltd v Chew Boon Hee_ <span style="background-color: #FAC0C0" class="citation">[[1997] 1 SLR 671]("https://www.open.gov.sg")</span> (“ _Essen System”_ ). The defendant submits that this case is not analogous to _Essen System_ as that decision involved an extreme case where the profit guarantees exceeded the amount paid to the seller for goodwill. 
