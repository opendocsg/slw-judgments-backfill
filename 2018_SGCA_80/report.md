...
[LawNet Editorial Note: This was an appeal from the decision of the High Court in <span style="background-color: #FAC0C0">[[2018] SGHC 26]("https://www.open.gov.sg")</span>.] 
...
_Wong Kok Mun Alvin and another_ <span style="background-color: #FAC0C0">[[2018] SGHC 26]("https://www.open.gov.sg")</span> (“the Judgment”). [note: 1] We set out only the facts that are relevant to the appeals before us. 
