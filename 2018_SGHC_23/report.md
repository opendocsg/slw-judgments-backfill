...
_Prosecutor_ <span style="background-color: #FAC0C0">[[2006] 1 SLR(R) 548]("https://www.open.gov.sg")</span> at [8] and [10] that the presumptions in ss 17 and 18 of the MDA cannot be applied conjunctively. 
...
16     As laid down by the Court of Appeal in _Raman Selvam s/o Renganathan v Public Prosecutor_ <span style="background-color: #FAC0C0">[[2004] 1 SLR(R) 550]("https://www.open.gov.sg")</span>, the conditions necessary for a conviction for an offence under s 5(1)( _a_ ) read with s 5(2) of the MDA are (at [35]): 
