<span style="background-color: #FAC0C0"># Monetary Authority of Singapore v Wang Boon Heng and another 
...
See _Tan Boon Heng v Lau Pang Cheng David_ [[2013] 4 SLR 718]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Tan Boon Heng_ ”) at [7]. 
...
33     In an appeal against sentence imposed in criminal cases, the appellate court will not ordinarily disturb the sentence imposed by the trial court except where it is satisfied that: 
 ...
 See Public Prosecutor v UI [[2008] 4 SLR(R) 500]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ PP v UI ”) at [12], citing Tan Koon Swan v Public Prosecutor [1985–1986] SLR(R) 976 (“ Tan Koon Swan ”) at [2]–[5], [8] and [9]. I shall refer to this as the “Sentencing Standard” and this is the third standard under consideration. 
...
66     After considering the above factors (and any other factor which the court considers relevant in the circumstances of the case at hand), the court should then identify a _preliminary_ quantum of civil penalty that should be imposed. In so doing, the court should consider “the range of conduct that may be captured at either end of the [penalty] range”, and then determine where in that spectrum the conduct that is before the court falls (see, by analogy, _Mehra Radhika v Public Prosecutor_ [[2015] 1 SLR 96]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [29]). 
