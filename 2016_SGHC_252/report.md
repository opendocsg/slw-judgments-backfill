...
57     In _Nagase Singapore Pte Ltd v Ching Kai Huat_ <span style="background-color: #FAC0C0" class="citation">[[2008] 1 SLR(R) 80]("https://www.open.gov.sg")</span> at [23], Prakash J (as she then was) summarised the elements of both forms of conspiracy as such: 
...
_v Burhan Uray (alias Wong Ming Kiong) and Others_ <span style="background-color: #FAC0C0" class="citation">[[2004] SGHC 115]("https://www.open.gov.sg")</span>), it is necessary to show that they came together to take some form of concerted action, whether lawful or otherwise, in pursuit of 
