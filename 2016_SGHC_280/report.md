...
[LawNet Editorial Note: The appeal to this decision in Civil Appeal No 9 of 2017 was dismissed by the Court of Appeal on 5 January 2018. See <span style="background-color: #FAC0C0">[[2018] SGCA 1]("https://www.open.gov.sg")</span>.] 
...
The High Court further noted (at [110]) that in _Genelabs Diagnostics Pte Ltd v Institut Pasteur and another_ <span style="background-color: #FAC0C0">[[2000] 3 SLR(R) 530]("https://www.open.gov.sg")</span>, the Court of Appeal had, in computing the length of delay, only took into account the period starting from when the plaintiffs first became aware of the infringing acts. 
