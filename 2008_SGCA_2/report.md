...
1       The appellant was convicted in the High Court of trafficking in 30.37g of diamorphine under s 5(1)( _a_ ) read with s 5(2) of the Misuse of Drugs Act (Cap 185, 2001 Rev Ed) and was sentenced to death accordingly: see _PP v Teo Cheow Kim_ <span style="background-color: #FAC0C0">[[2007] SGHC 70]("https://www.open.gov.sg")</span> (“the GD”). The charge on which the appellant was convicted (“the Charge”) read as follows: 
