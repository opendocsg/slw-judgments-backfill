...
Reference was made to a number of local decisions where our courts have presumed Singapore law to be the same as foreign law (see, _eg_ , _K-Rex Finance Ltd v Cheng Chih Cheng_ <span style="background-color: #FAC0C0" class="citation">[[1992] 3 SLR(R) 296]("https://www.open.gov.sg")</span>, _Goh Chok Tong v Tang Liang Hong_ <span style="background-color: #FAC0C0" class="citation">[[1997] 1 SLR(R) 811]("https://www.open.gov.sg")</span>, _Parno v SC Marine Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[1999] 3 SLR(R) 377]("https://www.open.gov.sg")</span> and _Ong Jane Rebecca v Lim Lie Hoa_ <span style="background-color: #FAC0C0" class="citation">[[2003] SGHC 126]("https://www.open.gov.sg")</span>). Accordingly, PSB argued that Rule 18 applies, and that it is entitled to judgment on the counterclaim. 
