...
11     The applicable test to determine if divorce proceedings should be stayed in Singapore on the grounds of _forum non conveniens_ is the test enunciated in _Spiliada Maritime Corporation v Cansulex Ltd_ [1987] AC 460 (“the _Spiliada_ test”): see _VH v VI and another_ <span style="background-color: #FAC0C0" class="citation">[[2008] 1 SLR(R) 742]("https://www.open.gov.sg")</span> and _Mala Shukla v Jayant Amritanand Shukla (Danialle An, co-respondent)_ <span style="background-color: #FAC0C0" class="citation">[[2002] 1 SLR(R) 920]("https://www.open.gov.sg")</span> (“ _Mala Shukla_ ”). The _Spiliada_ test consists of two stages: 
...
( _Eng Liat Kiang v Eng Bak Hern_ <span style="background-color: #FAC0C0" class="citation">[[1995] 2 SLR(R) 851]("https://www.open.gov.sg")</span> at [34]). The first task was thus to determine the subject matters in dispute in this case. 
