<span style="background-color: #FAC0C0"># Ramalingam Ravinthran v Public Prosecutor 
...
[LawNet Editorial Note: This was an appeal from the decision of the High Court in [[2009] SGHC 265]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">.] 
...
37     The Prosecution’s response to the appellant’s arguments may be summarised as follows: 
 ...
 (a) As the Judge’s decision was based on findings of fact, it was trite that an appellate court would not disturb such findings unless they were plainly wrong or clearly arrived at against the weight of the evidence, or unless there was a misdirection as to the law (citing Public Prosecutor v Victor Rajoo [[1995] 3 SLR(R) 189]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, Public Prosecutor v Mohammed Liton Mohammed Syeed Mallik [[2008] 1 SLR(R) 601]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> and Tan Kiam Peng ). 
