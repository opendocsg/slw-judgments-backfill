<span style="background-color: #FAC0C0"># Hanwha Non-Life Insurance Co Ltd v Alba Pte Ltd 
...
32     In _Zurich Insurance (Singapore) Pte Ltd v B-Gold Interior Design & Construction Pte Ltd_ [[2009] 3 SLR(R) 1029]("https://www.open.gov.sg")</span>, (“ _Zurich Insurance_ ”), the Court of Appeal endorsed the contextual approach for the interpretation of a contract with a qualification (at [122]) that when interpreting a contract, “extrinsic evidence is only employed to illuminate the contractual language and not as a pretext to contradict or vary it”. VK Rajah JA stated (at [132]) as follows: 
