...
228    Mr Ng argues that the Without Notice Clause is onerous and unusual and therefore must have been drawn to ST’s notice if he were to be bound by it. The question of whether a clause in a contract in unusual is a question of fact. As noted in _United Overseas Bank Ltd v The Asiatic Enterprises (Pte) Ltd_ <span style="background-color: #FAC0C0">[[1999] 2 SLR(R) 671]("https://www.open.gov.sg")</span> at [41], the court would have to assess all circumstances including the experience of the parties in deciding if the clause in question in onerous or unusual. 
