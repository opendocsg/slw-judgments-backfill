...
108    It is not disputed that an applicant seeking leave to appeal must demonstrate that there exist questions falling within at least one of the following three limbs ( _Lee Kuan Yew v Tang Liang Hong_ <span style="background-color: #FAC0C0" class="citation">[[1997] 2 SLR(R) 862]("https://www.open.gov.sg")</span> at [16]): 
...
120    Mr Tan, counsel for the Plaintiff, points to the first instance judgment in _HSBC Trustee (Singapore) Ltd v Lucky Realty Co Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2015] 3 SLR 885]("https://www.open.gov.sg")</span> (“ _HSBC Trustee (Singapore) Ltd_ ”) where the learned Judge said (at [57]): 
