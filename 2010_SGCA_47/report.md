<span style="background-color: #FAC0C0"># Cooperatieve Centrale Raiffeisen-Boerenleenbank BA (Trading as Rabobank International), 
...
[LawNet Editorial Note: The decision from which this appeal arose is reported at [[2010] 3 SLR 48]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">.] 
...
_Associates Far East Ltd_ [[2007] 4 SLR(R) 855]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Britestone_ ”) at [58]: 
...
We note that under ss 3(3) – (5) of the Evidence Act, there are three possible conclusions which a court assessing the evidence before it may make, _viz_ , that a fact is proved, disproved, or not proved, respectively. Where the evidence suffices to satisfy the court that a fact exists, that fact will be held to have been proved. Conversely, where the evidence suffices to satisfy the court as to the _non-existence_ of a particular fact, that fact will be held to have been disproved: _Loo Chay Sit v Estate of Loo Chay Loo, deceased_ [[2010] 1 SLR 286]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, at [22]. However, the court is not bound to make a choice between finding that a fact is either proved or disproved. It is open to the court to select a third option, _i.e_ ., that a fact is not proved. A statement that a fact is not proved simply 
...
39     We also note that unfortunately, a great deal of uncertainty exists in the area of the law of set-off. In _OCWS Logistics Pte Ltd v Soon Meng Construction Pte Ltd_ [[1998] 3 SLR(R) 888]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, the High Court has set out the historical context of the development of the law of set-off (at [7]): 
...
49     More recently, in _Tribune Investment Trust Inc v Soosan Trading Co Ltd_ [[2000] 2 SLR(R) 407]("https://www.open.gov.sg")</span>, this court considered the question of whether a contract may be inferred from correspondence and contemporaneous conduct of the parties in the absence of an express written agreement and stated (at [40]): 
