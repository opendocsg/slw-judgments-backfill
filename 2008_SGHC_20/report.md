...
13     Notwithstanding the unusual sequence of events, the District Judge (in _PP v Randy Chan Kum Hong_ <span style="background-color: #FAC0C0">[[2007] SGDC 232]("https://www.open.gov.sg")</span> (“the GD”)) refused to award any discount on sentence on the following grounds (at [12]): 
...
21     More recently, the effect of prosecutorial delay on sentencing was considered in the local context by Yong Pung How CJ in _Tan Kiang Kwang v PP_ <span style="background-color: #FAC0C0">[[1996] 1 SLR 280]("https://www.open.gov.sg")</span> (“ _Tan Kiang Kwang_ ”) in the following terms (at 286, [20]): 
