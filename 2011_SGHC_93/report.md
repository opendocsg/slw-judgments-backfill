<span style="background-color: #FAC0C0"># Ong Chow Hong (alias Ong Chaw Ping) v Public Prosecutor and another appeal 
...
12     Pronouncements from different Singapore courts to date had, with varying emphasis, sought to justify like orders on the basis of either “punishment” or “protection”. In _Lim Teck Cheng v AttorneyGeneral_ [[1995] 3 SLR(R) 223]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Lim Teck Cheng_ ”) at [13], Amarjeet Singh JC held that the disqualification provision was essentially protective in nature. However, in the subsequent case of _Lee Huay Kok v Attorney-General_ [[2001] 3 SLR(R) 287]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Lee Huay Kok_ ”) at [10], Choo Han Teck JC 
...
24     Therefore, given the disclosure-based regime, there is a corollary need for the courts to ensure the accuracy of market disclosures to the public. In _Public Prosecutor v Wang Ziyi Able_ [[2008] 2 SLR(R) 1082]("https://www.open.gov.sg")</span> at [1], I remarked: 
