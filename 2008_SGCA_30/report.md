...
3       This was an appeal against the decision of the High Court Judge (“the Judge”) who dismissed the appellant’s claims in contract and negligence against the respondents on the preliminary issue that such claims were time-barred under s 24A(3)( _b_ ) of the Limitation Act (Cap 163, 1996 Rev Ed). The Judge’s decision is reported as _Lian Kok Hong v Ow Wah Foong_ <span style="background-color: #FAC0C0" class="citation">[[2007] 4 SLR 742]("https://www.open.gov.sg")</span> (“the Judgment”). After hearing counsel, we dismissed the appeal. We now set out our detailed reasons for having so decided. 
