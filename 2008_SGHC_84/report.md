...
27     Coming back to the issue before me, it was for Mr Siraj to persuade me to grant the extension of time. It was not disputed that the same four factors have to be taken into account for an omission to seek further arguments as are applicable to a failure to file a Notice of Appeal on time (see _DenkoHLB Sdn Bhd v Fagerdala Singapore Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2002] 3 SLR 357]("https://www.open.gov.sg")</span>). The four factors are: 
