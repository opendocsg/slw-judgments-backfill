...
[LawNet Editorial Note: The decision from which this appeal arose is reported at <span style="background-color: #FAC0C0">[[2015] SGHC 148]("https://www.open.gov.sg")</span> .] 
...
_others_ <span style="background-color: #FAC0C0">[[2001] 3 SLR(R) 610]("https://www.open.gov.sg")</span> the general proposition that where “rudimentary drawings” are concerned, infringement of copyright would only result if there was “almost an exact reproduction” (at [45]). 
