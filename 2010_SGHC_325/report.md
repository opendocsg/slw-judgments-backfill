<span style="background-color: #FAC0C0"># Dr Eric Gan Keng Seng v Singapore Medical Council 
...
22     With these principles in mind, we now turn to address the issues raised in this appeal (see [19] above). The first issue is whether the findings of the DC went beyond the ambit of the Charge (set out above at [10]). The starting point is, and must be, that Dr Gan is only required to respond to the charge and nothing more (see _Lim Teng Ee Joyce v Singapore Medical Council_ [[2005] 3 SLR(R) 709]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [26] and _Ho Paul v Singapore Medical Council_ [[2008] 2 SLR(R) 780]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [9] (“ _Ho Paul_ ”)). 
