<span style="background-color: #FAC0C0"># Harris Hakim v Allgreen Properties Ltd 
...
30\. Turning to the words 'without prejudice to any other rights available to the vendor at law or in equity', we are of the opinion that they are intended to preserve to the developer 'other rights' he may have, such as his right to payment of other sums which has accrued under the agreement: see _Lim Lay Bee and Anor v Allgreen Properties Ltd_ [[1999] 1 SLR 471]("https://www.open.gov.sg")</span>. The words 'other rights' mean rights other than the rights to damages which the developer is entitled to recover under paragraphs (b) and (c) of cl 5(3) of the Agreement. 
