...
39     Bumi submits that the fact that BAB controls BAOHL does not, _ipso fac to_ , mean that BAB is liable for BAOHL’s breach. Bumi relies on the following passage from _ARS v ART and another_ <span style="background-color: #FAC0C0" class="citation">[[2015] SGHC 78]("https://www.open.gov.sg")</span> (“ _ARS_ ”) at [252]: 
