...
26     Under O 53, r 1(3) of the Rules, an applicant for leave to apply for a mandatory order, prohibiting order or quashing order must serve the _ex parte_ originating summons, the statement referred to in O 53, r 1(2) and the supporting affidavit on the AG. The AG would then have the right to attend and be heard at the hearing of the application ( _Chan Hiang Leng Colin and others v Minister for Information and the Arts_ <span style="background-color: #FAC0C0" class="citation">[[1995] 2 SLR(R) 627]("https://www.open.gov.sg")</span> at [4]-[5]; also see _Singapore Civil Procedure 2007_ (G P Selvam chief ed) (Sweet & Maxwell Asia, 2007) (“ _Singapore Civil Procedure 2007_ ”) at para 53/8/26). 
...
It is to be noted that the _Wednesbury_ Test has been endorsed in numerous Singapore cases (see, for example, _Chan Hiang Leng Colin_ at [39], _Chee Siok Chin and others v Minister for Home Affairs and another_ <span style="background-color: #FAC0C0" class="citation">[[2006] 1 SLR(R) 582]("https://www.open.gov.sg")</span> at [94] and _Mir Hassan bin Abdul Rahman and another v AttorneyGeneral_ <span style="background-color: #FAC0C0" class="citation">[[2009] 1 SLR(R) 134]("https://www.open.gov.sg")</span> at [21]). 
