<span style="background-color: #FAC0C0"># Mohammad Ashik bin Aris v Public Prosecutor 
...
[LawNet Editorial Note: This was an appeal from the decision of the High Court in [[2011] SGHC 111]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">.] 
...
10     The significance of compliance with s 31(4)( _b_ ) is that if there are positive results from both of the urine tests carried out pursuant to this subsection, the s 22 presumption will operate to presume that the accused person has, in contravention of s 8( _b_ ), consumed the controlled drug detected in his urine samples. This means that both the _actus reus_ and the _mens rea_ of the s 8( _b_ ) offence are presumed by s 22: see _Vadugaiah Mahendran v Public Prosecutor_ [[1995] 3 SLR(R) 719]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [24] (see only the first three sentences); and _Public Prosecutor v Tan Loon Lui_ [[2003] 2 SLR(R) 216]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [6]. In examining whether the HSA’s urine-testing procedures at the material time complied with s 31(4)( _b_ ), we considered three specific questions, namely: 
