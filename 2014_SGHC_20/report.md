...
the findings in the Consultants’ Reports. [note: 45] The Defendants cited the following passage from _Zurich Insurance (Singapore) Pte Ltd v B-Gold Interior Design & Construction Pte Ltd_ <span style="background-color: #FAC0C0">[[2008] 3 SLR(R) 1029]("https://www.open.gov.sg")</span> (“ _Zurich Insurance_ ”) at [132]: 
...
66     In _Hiap Hong & Co Pte Ltd v Hong Huat Development Co (Pte) Ltd_ <span style="background-color: #FAC0C0">[[2001] 1 SLR(R) 458]("https://www.open.gov.sg")</span>, the Court of Appeal cited _Sutcliffe_ with approval, making the following observations (at [15]–[16]): 
