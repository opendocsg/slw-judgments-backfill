...
[LawNet Editorial Note: This was an appeal from the decision of the High Court in <span style="background-color: #FAC0C0">[[2017] SGHC 25]("https://www.open.gov.sg")</span>.] 
...
After a trial of the matter, the Judge convicted the Appellant. His reasons can be found at _Public Prosecutor v Sinnappan a/l Nadarajah_ <span style="background-color: #FAC0C0">[[2017] SGHC 25]("https://www.open.gov.sg")</span> (“the Judgment”). The Appellant was also sentenced to life imprisonment and 15 strokes of the cane pursuant to s 33B(2) of the MDA. 
...
24     To rebut the presumption in s 18(2), the accused must prove, on a balance of probabilities, that he did not have knowledge of the nature of the controlled drug. In _Dinesh Pillai a/l K Raja Retnam v Public Prosecutor_ <span style="background-color: #FAC0C0">[[2012] 2 SLR 903]("https://www.open.gov.sg")</span>, this court observed (at [18]) that the accused can do so by showing that “he did not know or could not reasonably be expected to have known the nature of the controlled drug”. 
