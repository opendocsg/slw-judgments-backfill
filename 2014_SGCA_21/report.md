...
19     One critical requirement in law for the formation of any binding contract is the certainty of its terms. This requirement was discussed in _T2 Networks Pte Ltd v Nasioncom Sdn Bhd_ <span style="background-color: #FAC0C0" class="citation">[[2008] 2 SLR(R) 1]("https://www.open.gov.sg")</span> (“ _T2 Networks_ ”) where Judith Prakash J held (at [44]) that a settlement agreement was not legally binding because some of its terms were uncertain. Of particular relevance was cl 2 of the settlement agreement which provided that: 
