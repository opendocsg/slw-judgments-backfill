<span style="background-color: #FAC0C0"># Khor Bee Im v Wong Tee Kee 
...
9\. In _L v L_ [[1997] 1 SLR 222]("https://www.open.gov.sg")</span>, custody of the child, then aged 2 years, was, consequent upon the divorce of the parents, granted to the mother. The mother subsequently married T and, without consulting the father, changed the childs surname, by Deed Poll, from M to T. The father discovered this change when the child enrolled in primary school and took out an application to declare the Deed Poll void and inoperative. 
