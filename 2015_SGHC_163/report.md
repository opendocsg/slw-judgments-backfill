...
27     The Plaintiffs further argue that the disposal of the matter renders Mr Gunaseelan’s applic ation for the OA’s sanc tion nugatory, and on the authority of _Standard Chartered Bank v Loh Chong Yong Thomas_ <span style="background-color: #FAC0C0" class="citation">[[2010] 2 SLR 569]("https://www.open.gov.sg")</span>, the OA was in no position to grant a “retrospec tive sanc tion” for the deed that c ame in only after the matter had already been disposed of. Given my c onc lusions above, the issue of whether the OA has powers to grant “retrospec tive sanc tion” is now moot. 
