...
It should be noted that a _Quistclose_ trust does not only arise in a situation where money was paid as a _loan_ for a specific purpose (see the decision of the High Court in _Singapore Tourism Board v Children's Media Ltd and others_ <span class="citation">[2008] 3 SLR(R) 981</span> at [157]). 
...
125    As a litigant in person, Andy is entitled to a claim against Sarah for compensatory costs under O 59 r 18A of the Rules of Court (Cap 322, R 5, 2006 Rev Ed), for the time spent for action, as well as other reasonable expenses (see _Aldabe Fermin v Standard Chartered Bank_ <span class="citation">[2010] 3 SLR 722</span> at [130]). The time spent for the Trust Claim was significantly more than the time for the Contract Claims. Given that the plaintiffs only succeeded in one aspect of their Contract Claims and Sarah failed in the Trust Claim against Tik, I shall order Sarah to pay 50% of the costs of the action to Tik to be taxed if not agreed. No further order as to costs in relation to Ivy. 
