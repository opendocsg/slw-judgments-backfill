...
20     In sentencing the appellant, the district judge considered the fact that the appellant had pleaded guilty in the first instance and had no previous convictions. The district judge also considered that the appellant’s offences resulted from her kleptomaniacal impulse. However, he relied on the case of _Siauw Yin Hee v PP_ <span style="background-color: #FAC0C0">[[1995] 1 SLR 514]("https://www.open.gov.sg")</span> at 516, [9] where I had stated that: 
