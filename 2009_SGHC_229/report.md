...
128    When dealing with conflicting medical evidence which is the case here (where the plaintiff’s expert witness insisted that Mdm Goh possessed the requisite testamentary capacity when she executed the 1996 Will whilst the defendant’s expert witnesses contended otherwise), the function of the court to carefully weigh the conflicting evidence is of paramount importance. This is not an easy task. In a recent decision by CJ Chan Sek Keong in _George Abraham Vadakathu v Jacob George_ <span class="citation">[2009] 3 SLR 631</span> (“ _George Abraham Vadakathu_ ”) at [64] he said: 
