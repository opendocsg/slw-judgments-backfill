...
_Department Store Pte Ltd_ <span style="background-color: #FAC0C0">[[2006] 2 SLR(R) 690]("https://www.open.gov.sg")</span> (“The Polo/Lauren Co”) at [8] albeit in the context of the trade marks infringement provision, _ie_ , s 27(2)( _b_ ) TMA, the wording of which mirrors that of s 8(2) ( _b_ ) TMA: 
...
80     It is fair to say that the average consumer in Singapore is one who is literate, educated, exposed to the world and unlikely to be easily hoodwinked, see _McDonald’s Corp v Future Enterprises Pte Ltd_ <span style="background-color: #FAC0C0">[[2005] 1 SLR(R) 177]("https://www.open.gov.sg")</span> at [64]. 
