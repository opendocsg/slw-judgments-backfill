<span style="background-color: #FAC0C0"># AON v AOO 
...
9       The first question which I had to consider was as to the proper approach to the original setting aside application. The DJ had cited the case of _Chng Yock Eng v Kwa Teck Meng_ [[2004] SGDC 268]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Chng Yock_ Eng”), a decision of District Judge Lim Hui Min (“DJ Lim”), as authority for the proposition that a court could set aside an order on ancillary matters notwithstanding that it had been properly obtained if the applicant could show that she had a real prospect of success in the case if the order was set aside. 
