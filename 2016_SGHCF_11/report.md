...
7       The various steps to be taken in an asset division may be framed within the broad framework used by the Court of Appeal in _Tan Hwee Lee v Tan Cheng Guan and another appeal and another matter_ <span style="background-color: #FAC0C0">[[2012] 4 SLR 785]("https://www.open.gov.sg")</span> (“ _Tan Hwee_ Lee”) as follows: 
 ...
 (b) Stage 2: dividing the assets: Here the court must apply the structured approach set out in ANJ v ANK <span style="background-color: #FAC0C0">[[2015] 4 SLR 1043]("https://www.open.gov.sg")</span> (“ ANJ v ANK ”). 
...
9       This issue of the operative date was dealt with in _ARY v ARX_ <span style="background-color: #FAC0C0">[[2016] 2 SLR 686]("https://www.open.gov.sg")</span> (“ _ARY v ARX_ ”), where the Court of Appeal decided that a starting point or default position in the exercise of the court’s discretion should be to use the date of interim judgment as the relevant operative date, explaining as follows: 
