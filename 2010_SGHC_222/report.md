...
This principle was acknowledged in _Coastland Properties Pte Ltd v Lin Geok Choo_ <span style="background-color: #FAC0C0" class="citation">[[1999] 3 SLR(R) 890]("https://www.open.gov.sg")</span> at [2], although Choo Han Teck JC concluded in that case that damages could still be an adequate remedy in some circumstances. There is also clear authority that specific performance of a sale of a HDB flat can be ordered (see _Govindaraju and another v Ganasen and another_ <span style="background-color: #FAC0C0" class="citation">[[1994] 3 SLR(R) 815]("https://www.open.gov.sg")</span>). 
