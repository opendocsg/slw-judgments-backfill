<span style="background-color: #FAC0C0"># Wong Chee Siong and another v Tan Boon Hwa and another 
...
This principle was acknowledged in _Coastland Properties Pte Ltd v Lin Geok Choo_ [[1999] 3 SLR(R) 890]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [2], although Choo Han Teck JC concluded in that case that damages could still be an adequate remedy in some circumstances. There is also clear authority that specific performance of a sale of a HDB flat can be ordered (see _Govindaraju and another v Ganasen and another_ [[1994] 3 SLR(R) 815]("https://www.open.gov.sg")</span>). 
