...
[LawNet Editorial Note: The decision from which this appeal arose is reported at <span style="background-color: #FAC0C0" class="citation">[[2012] 3 SLR 953]("https://www.open.gov.sg")</span> .] 
...
132    As corporeal, tangible property, there is no doubt that the share certificates can be converted. The question is whether they are worth more than just pieces of paper. In _Pacrim Investments Pte Ltd v Tan Mui Keow Claire and another_ <span style="background-color: #FAC0C0" class="citation">[[2005] 1 SLR(R) 141]("https://www.open.gov.sg")</span>, Andrew Ang J held (at [18]) that: 
