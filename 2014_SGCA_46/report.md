<span style="background-color: #FAC0C0"># AYM v AYL and another appeal 
...
[LawNet Editorial Note: This was an appeal from the decision of the High Court in [[2013] SGHC 237]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> .] 
...
3       The appeals before us arise from the decision in _AYL v AYM_ [[2013] SGHC 237]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“the GD”) concerning the variation of the terms of the Consent Order providing for maintenance payments by the Husband to both the Wife and the Children. 
...
5       The dispute between the parties has resulted in substantial litigation in both the State Courts and the Supreme Court, and has already come up before the Court of Appeal on one previous occasion. The facts of the case have been set out in detail in a number of decisions (see _AYL v AYM_ [[2012] SGHC 64]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, _AYM v AYL_ [[2013] 1 SLR 924]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, and the GD), and it is unnecessary to canvass them again at length. For present purposes, we set out only the facts that are material to our decision. 
...
18     The following principles concerning lump sum maintenance payments may be extracted from the case law: 
 ...
 (a) A lump sum payment allows for a clean break in the marriage and should be availed of whenever feasible ( Lee Puey Hwa v Tay Cheow Seng [[1991] 2 SLR(R) 196]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ Lee Puey Hwa ”) at [9]). Such a clean break may help avoid further litigation and acrimony between the parties ( Wan Lai Cheng v Quek Seow Kee and another appeal and another matter [[2012] 4 SLR 405]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ Wan Lai Cheng ”) at [88]). 

 (b) A lump sum payment should not be ordered if it would cripple the husband financially ( Lee Puey Hwa at [9]; and Neo Mei Lan Helena v Long Melvin Anthony [[2002] 2 SLR(R) 616]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ Neo Mei Lan Helena ”)). 
