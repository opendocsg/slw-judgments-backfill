<span style="background-color: #FAC0C0"># Luyono Lam v Public Prosecutor 
...
20     I recognise that it is trite law that an appellate court should not interfere with a sentence meted out by the trial judge unless it is satisfied that (see _Public Prosecutor v Kwong Kok Hing_ [[2008] 2 SLR(R) 684]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [14]): 
