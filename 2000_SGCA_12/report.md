...
The applications were heard before the learned Chief Justice on 27 October 1999 and at the conclusion of the hearing he dismissed them. He held that it is only in exceptional circumstances that the court would exercise its discretion to grant such applications and that the appellants had not shown any cogent and persuasive reasons as to why the applications should be allowed: see **Microsoft Corporation & Ors v SM Summit Holdings Ltd & Anor** <span style="background-color: #FAC0C0" class="citation">[[2000] 1 SLR 343]("https://www.open.gov.sg")</span>. It is against this decision that the present two appeals are brought. 
