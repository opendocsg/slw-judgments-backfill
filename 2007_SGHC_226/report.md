...
131    It is true that in the Singapore case of _Chua Choon Lim Robert v M N Swami_ <span style="background-color: #FAC0C0" class="citation">[[2000] 4 SLR 494]("https://www.open.gov.sg")</span>, Amarjeet Singh JC ruled that the High Court has the power under its inherent jurisdiction to make a restraining order in the context of civil proceedings. He also said that such a power is in addition to 
