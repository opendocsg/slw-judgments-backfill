...
13     The last authority cited by the defendants was _Progress Software Corp (S) Pte Ltd v Central Provident Fund Board_ <span style="background-color: #FAC0C0" class="citation">[[2003] 2 SLR 156]("https://www.open.gov.sg")</span>. In that case, three issues were raised in the High Court. Two were preliminary issues of procedure. They were decided in favour of the appellants. The third was a substantive issue and was decided in favour of the respondents. The judge having dismissed the appellant’s application with costs, the latter appealed to the Court of Appeal contending that as the respondents had succeeded on only one out of three issues, they should have been awarded onethird of their costs below. The appellants relied on O 59 r 6A of the Rules of Court which came into effect on 15 December 2001 in support of their contention. Rule 6A provides: 
