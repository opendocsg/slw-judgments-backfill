<span style="background-color: #FAC0C0"># Dewi Sukowati v Public Prosecutor 
...
[LawNet Editorial Note: This was an appeal from the decision of the High Court in [[2016] SGHC 152]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">.] 
...
15     We begin with the observation that has been made in previous cases of culpable homicide that the sentencing inquiry in these cases must always be fact sensitive given the wide variety of circumstances in which these offences are committed (see _Lim Ghim Peow v Public Prosecutor_ [[2014] 4 SLR 1287]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Lim Ghim Peow_ ”) at [55]). 
