...
15     It is trite law that “where words are found to be plain and unambiguous, they must be interpreted according to the plain and unambiguous language without extraneous help. The presumption is that parties have used ordinary words which are written in the document to convey their ordinary meaning”: _Citicorp Investment Bank v Wee Ah Kee_ <span class="citation">[1997] 2 SLR 759</span> at [61], citing _L Schuler AG v Wickham Machine Tools Ltd_ [1974] AC 235. Given the unequivocal language employed in cl 11.1 of the Variation Agreement, and the lack of any words limiting the effect of that clause to 
