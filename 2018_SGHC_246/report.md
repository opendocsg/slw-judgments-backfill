...
66     In this regard, IHC argued that the Crest Funds could not rely on estoppel in defiance of a statute, citing _Joshua Steven v Joshua Deborah Steven_ <span style="background-color: #FAC0C0" class="citation">[[2004] 4 SLR(R) 403]("https://www.open.gov.sg")</span> (“ _Joshua Steven_ ”). In 
...
75     In general, the right to avoid a contract may be lost by affirmation where the court is satisfied that the party seeking to avoid the contract ( _Aero-Gate Pte Ltd v Engen Marine Engineering Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2013] 4 SLR 409]("https://www.open.gov.sg")</span> at [42]): 
