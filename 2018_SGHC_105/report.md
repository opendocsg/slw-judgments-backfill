...
31     Finally, a debtor may seek to rebut the presumption of insolvency under s 254(2)( _a_ ) of the Companies Act by showing that the company was in fact solvent: see _Export-Import Bank of India v Surya Pharmaceutical (Singapore) Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2015] SGHC 258]("https://www.open.gov.sg")</span> at [14]; _Starluck Construction Pte Ltd v HSS Engineering Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2013] SGHC 72]("https://www.open.gov.sg")</span> at [7] (“ _Starluck Construction_ ”). 
