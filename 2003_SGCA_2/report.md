<span style="background-color: #FAC0C0"># Vignes s/o Mourthi and Another v Public Prosecutor and Another Case 
...
62     Counsel for Moorthy accepted that where an alibi defence is raised, the accused has the evidential burden of proof. However, this burden is not on a balance of probabilities but only to raise a reasonable doubt. In our view, this submission is correct. This Court had in _Ramakrishnan s/o Ramayan v PP_ [[1998] 3 SLR 645]("https://www.open.gov.sg")</span> stated (at p.653) that "an acquittal must follow from reasonable doubt that the appellant might have been elsewhere at the material time." 
