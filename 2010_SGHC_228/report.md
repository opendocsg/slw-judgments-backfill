...
26     In _The Polo/Lauren Co LP v Shop in Department Store Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2006] 2 SLR(R) 690]("https://www.open.gov.sg")</span> (“ _Polo/Lauren_ ”), the Court of Appeal adopted the test outlined in _British Sugar plc v James Robertson & Sons Ltd_ [1996] RPC 281 ("the _British Sugar_ test") for determining whether or not there has been an infringement under s 27(2)( _b_ ) of the Act. Applying the _British Sugar_ test, section 27(2)( _b_ ) will be infringed in the present case if: 
