...
60     Furthermore, the offence of dangerous driving is one that calls for both specific and general deterrence ( _D’Rozario Pancratius Joseph v Public Prosecutor_ <span class="citation">[2015] SGHC 46</span> at [27]). Allowing a court to take into account a compounded offence under the RTA (or its subsidiary legislation) gives 
