<span style="background-color: #FAC0C0"># Chua Chuan Heng Allan v Public Prosecutor 
...
Thus, the court’s power to backdate a custodial sentence is purely discretionary: _Sinniah Pillay v PP_ [[1992] 1 SLR 225]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">. The backdating of a custodial sentence is an exception to the general rule of sentencing and is never available as of right. 

**_The court is not obliged to exercise its discretion to backdate_** 

9       It is settled law that the court is not obliged to backdate a sentence of imprisonment in any case. In _Mani Nedumaran v PP_ [[1998] 1 SLR 411]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, the court stated: 
...
10     The fact that an offender has spent time in remand does not necessarily increase the likelihood that his sentence will be backdated. This is evidenced by the case of _PP v Wong Siu Fai_ [[2002] 3 SLR 276]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, where the offender pleaded guilty to having committed carnal intercourse against the order of nature on a five year old boy. In that case, the court refused to backdate the offender’s custodial sentence because it was of the opinion that “the five months imprisonment already served should be part of the punishment given the circumstances of [the] case.” 
