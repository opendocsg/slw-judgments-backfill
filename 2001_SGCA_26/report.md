...
## death of Kheng. The judgment was upheld on appeal by the Court of Appeal (<span style="background-color: #FAC0C0" class="citation">[[1993] 3 SLR 148]("https://www.open.gov.sg")</span>) and 

## finally by the Privy Council (<span style="background-color: #FAC0C0" class="citation">[[1996] 2 SLR 297]("https://www.open.gov.sg")</span>). 
...
### SLR 45, Ching Mun Fong v Liu Cho Chit <span style="background-color: #FAC0C0" class="citation">[[2000] 1 SLR 51]("https://www.open.gov.sg")</span>, Greenhalgh v Mallard 
...
### Lee Kuan Yew <span style="background-color: #FAC0C0" class="citation">[[1999] 4 SLR 560]("https://www.open.gov.sg")</span>, Pettitt v Pettitt [1970] AC 777 followed, Shephard v Cartwright 
...
### <span style="background-color: #FAC0C0" class="citation">[[2000] 1 SLR 51]("https://www.open.gov.sg")</span> (folld) 
...
### <span style="background-color: #FAC0C0" class="citation">[[1999] 4 SLR 45]("https://www.open.gov.sg")</span> (folld) 
...
### <span style="background-color: #FAC0C0" class="citation">[[1999] 4 SLR 560]("https://www.open.gov.sg")</span> (folld) 
...
2\. The circumstances giving rise to the plea of _res judicata_ are primarily based on a judgment (unreported) given by the High Court in the consolidated action (S 1401/73 and S 2457/81), which judgment was upheld on appeal by this Court (<span style="background-color: #FAC0C0" class="citation">[[1993] 3 SLR 148]("https://www.open.gov.sg")</span> ) and finally by the Privy Council (<span style="background-color: #FAC0C0" class="citation">[[1996] 2 SLR 297]("https://www.open.gov.sg")</span>). 
...
36\. We ought to mention that Tng has also made an argument based on the presumption of advancement in view of the fact that there is no documentary proof of a gift. This presumption is essentially an evidential rule, based on relationship (e.g., husband and wife, father and son), to rebut the opposing presumption of a resulting trust where a transfer of property is made by one person to another without consideration. In _Teo Siew Har v Lee Kuan Yew_ <span style="background-color: #FAC0C0" class="citation">[[1999] 4 SLR 560]("https://www.open.gov.sg")</span>, this Court, after considering _Pettitt v Pettitt_ [1970] AC 777, observed that, in the context of husband and wife, the application of this presumption has diminished in recent years in line with changing social norms. It also noted that the current approach is to treat the presumption "as an evidential instrument of last resort where there is no direct evidence as to the intention of the parties rather than as an oft-applied rule of the thumb". 
