...
17     The above factors are non-exhaustive and a wide discretion is conferred upon the court in order to achieve a just and equitable division of the matrimonial assets (see _Tan Hwee Lee v Tan Cheng Guan and another appeal and another matter_ <span style="background-color: #FAC0C0">[[2012] 4 SLR 785]("https://www.open.gov.sg")</span> at [41] and _Yeo_ at [76]). 

18     A broad brush approach which takes into account both financial and non-financial contributions should be used in achieving a just and equitable division of matrimonial assets ( _Yeo_ at [78]; _NK v NL_ <span style="background-color: #FAC0C0">[[2007] 3 SLR(R) 743]("https://www.open.gov.sg")</span> (“ _NK v NL_ ”)). However, this does not mean that the court will meticulously investigate every minute sum each party has paid or incurred ( _NK v NL_ at [26]; _Yeo_ at [78]). Ultimately, the broad brush approach is “about feel and the court’s sense of justice” ( _Yeo_ at [76] and [81]). 
