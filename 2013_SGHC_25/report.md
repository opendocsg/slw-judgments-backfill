<span style="background-color: #FAC0C0"># Lee Siew Lin v Oh Choon 
...
17     The above factors are non-exhaustive and a wide discretion is conferred upon the court in order to achieve a just and equitable division of the matrimonial assets (see _Tan Hwee Lee v Tan Cheng Guan and another appeal and another matter_ [[2012] 4 SLR 785]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [41] and _Yeo_ at [76]). 

18     A broad brush approach which takes into account both financial and non-financial contributions should be used in achieving a just and equitable division of matrimonial assets ( _Yeo_ at [78]; _NK v NL_ [[2007] 3 SLR(R) 743]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _NK v NL_ ”)). However, this does not mean that the court will meticulously investigate every minute sum each party has paid or incurred ( _NK v NL_ at [26]; _Yeo_ at [78]). Ultimately, the broad brush approach is “about feel and the court’s sense of justice” ( _Yeo_ at [76] and [81]). 
...
21     Previous cases have established that “in a short and childless marriage, the division of matrimonial assets will usually be in accordance with the parties' direct financial contributions as nonfinancial contributions will be minimal” ( _Ong Boon Huat Samuel v Chan Mei Lan Kristine_ [[2007] 2 SLR(R) 729]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Ong_ ”) at [28]; _Wang Shi Huah Karen v Wong King Cheung Kevin_ [[1992] 2 SLR(R) 172]("https://www.open.gov.sg")</span> (“ _Wang_ ”) at [15]). However, I note that the effective length of the marriages in _Ong_ and _Wang_ ( _viz._ 19 months and one year respectively) were significantly shorter than the present case. Accordingly, I gave due consideration to both the financial and non-financial contributions of the parties in the present case. 
