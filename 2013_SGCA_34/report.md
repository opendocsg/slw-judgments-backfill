...
[LawNet Editorial Note: The decision from which this appeal arose is reported at <span style="background-color: #FAC0C0" class="citation">[[2013] 1 SLR 276]("https://www.open.gov.sg")</span>.] 
...
1       This criminal reference arose from a decision of the High Court in _Adnan bin Kadir v Public Prosecutor_ <span style="background-color: #FAC0C0" class="citation">[[2012] SGHC 196]("https://www.open.gov.sg")</span> (“the Judgment”). In the light of the Judgment, the Public Prosecutor (“the PP”) referred the following question of law of public interest (“the Question”) to this court pursuant to s 397(2) of the Criminal Procedure Code (Cap 68, 2012 Rev Ed) (“the CPC”): 
...
The convicts’ appeal was dismissed by the Court of Criminal Appeal in _Ko Mun Cheung and another v PP_ <span style="background-color: #FAC0C0" class="citation">[[1992] 1 SLR(R) 887]("https://www.open.gov.sg")</span> (“ _Ko Mun Cheung (CA)_ ”). The court held as follows: 
...
On appeal, the Court of Criminal Appeal in _Ng Kwok Chun and another v PP_ <span style="background-color: #FAC0C0" class="citation">[[1992] 3 SLR(R) 256]("https://www.open.gov.sg")</span> (“ _Ng Kwok Chun (CA)_ ”) affirmed the High Court judgment and held that the definition of “import” in the IA applied to the MDA: 
...
19     The argument adopted by defence counsel in _Ng Kwok Chun_ was repeated in _Tse Po Chung Nathan and another v PP_ <span style="background-color: #FAC0C0" class="citation">[[1993] 1 SLR(R) 308]("https://www.open.gov.sg")</span> (“ _Nathan Tse_ ”). Once again, it was rejected by the Court of Criminal Appeal, which held as follows (at [18]): 
...
20     More recently, in _Tan Kiam Peng v PP_ <span style="background-color: #FAC0C0" class="citation">[[2008] 1 SLR(R) 1]("https://www.open.gov.sg")</span> (“ _Tan Kiam Peng_ ”), this court applied the IA’s definition of “import” to s 7 of the MDA, albeit without further comment (at [56]–[57]). 
...
26     The defence of personal consumption _was_ directly addressed in _PP v Majid bin Abdul Rahman_ <span style="background-color: #FAC0C0" class="citation">[[2007] SGDC 222]("https://www.open.gov.sg")</span> (“ _Majid_ ”). In that case, the accused was charged with importing 1.23 grams of 
...
29     In deciding that s 7 refers only to importation for the purpose of trafficking, the High Court drew support from the reasoning in _Ong Ah Chuan_ , _Lau Chi Sing v PP_ <span style="background-color: #FAC0C0" class="citation">[[1988] 2 SLR(R) 451]("https://www.open.gov.sg")</span> (“ _Lau Chi Sing_ ”) and _Ng Yang Sek v PP_ <span style="background-color: #FAC0C0" class="citation">[[1997] 2 SLR(R) 816]("https://www.open.gov.sg")</span> (“ _Ng Yang Sek_ ”), three cases that have interpreted the word “traffic” in the MDA. 
...
38     In this regard, it is instructive to consider a case where the word “import” _was_ given a more restrictive meaning than that prescribed in the IA. In _Trade Facilities Pte Ltd and others v PP_ <span style="background-color: #FAC0C0" class="citation">[[1995] 2 SLR(R) 7]("https://www.open.gov.sg")</span> (“ _Trade Facilities_ ”), the respondents were charged with selling and importing counterfeit Hennessy XO cognac contrary to s 73 of the Trade Marks Act (Cap 332, 1992 Rev Ed) (“the 1992 TMA”) (s 73 of the 1992 TMA has since been amended and is now s 49 of the Trade Marks Act (Cap 332, 2005 Rev Ed)). Section 73 of the 1992 TMA stated: 
...
66     In _Low Kok Heng_ , Rajah JA explained that the strict construction rule should only be used as a last resort where all other interpretive tools (in particular, the purposive approach) have failed to resolve the ambiguity in a provision (at [38] and [57]): 
 ...
 38 The modern local position on the construction of penal statutes is appositely summarised by Yong Pung How CJ in Forward Food Management [<span style="background-color: #FAC0C0" class="citation">[[2002] 1 SLR(R) 443]("https://www.open.gov.sg")</span>] at [26] in the following terms: 
