...
31     The MCST cited _Management Corporation Strata Title Plan No 958 v Tay Soo Seng_ <span style="background-color: #FAC0C0">[[1992] 3 SLR(R) 818]("https://www.open.gov.sg")</span> (“ _Tay Soo Seng_ ”) in support of the proposition that the affected beams are not part of the common property. The court in that case decided that the glass panel separating the unit from a common corridor was not common property. GP Selvam JC (as he then was) further added at [13] 
