...
22     In _AQS v AQR_ <span style="background-color: #FAC0C0">[[2012] SGCA 3]("https://www.open.gov.sg")</span>, the husband (but not the wife) had signed a memorandum in the following terms: 
...
83     The structured approach in _ANJ v ANK_ <span style="background-color: #FAC0C0">[[2015] 4 SLR 1043]("https://www.open.gov.sg")</span> would have achieved the same result. I would have assigned the following ratio for each party’s direct and indirect contributions, presented in this table as follows: 
