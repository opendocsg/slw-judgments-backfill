...
9       The opinions of experts are relevant under s 47 of the Evidence Act (Cap 97). An opinion will, however, only be accepted if it fulfils the criteria enunciated in _Muhammad Jeffry v Public Prosecutor_ <span style="background-color: #FAC0C0">[[1997] 1 SLR 197]("https://www.open.gov.sg")</span>: 
