...
(see the 1st Schedule to the CPC). This meant that bail was not available to the Applicant as of right although the court could, in its discretion, decide to offer bail (see _Fatimah bte Kumin Lim v Attorney-General_ <span style="background-color: #FAC0C0" class="citation">[[2014] 1 SLR 547]("https://www.open.gov.sg")</span> at [24]). 
