<span style="background-color: #FAC0C0"># AZB v AYZ 
...
9       The husband argued that the Court of Appeal in _Re C (an infant)_ [[2003] 1 SLR(R) 502]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Re C_ ”) did not establish a mechanistic rule that the court would allow a primary caregiver’s application to relocate with the child unless one of two circumstances was shown: 
