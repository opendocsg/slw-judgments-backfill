<span style="background-color: #FAC0C0"># Ng Teck Sim Colin and another v Hat Holdings Pte Ltd and another and another appeal 
...
[LawNet Editorial Note: The decision from which these appeals arose is reported at [[2010] 4 SLR 840]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> .] 
...
38     As mentioned above (at [2]), the _Mocambique principle_ is that the court does not have jurisdiction to entertain proceedings involving the determination of title to foreign land (see Collins, _Dicey, Morris & Collins on The Conflict of Laws_ (Sweet & Maxwell, 14th Ed, 2006) (" _Dicey & Morris_ ") a t para 23R-021). In _Murakami Takako (executrix of the estate of Takashi Murakami Suroso, deceased) v Wiryadi Louse Maria and others_ [[2009] 1 SLR(R) 508]("https://www.open.gov.sg")</span>, this court reiterated (at [9]) that the _Mocambique_ rule and the personal equities exception to that rule are a part of Singapore law. 
