...
11     The District Judge gave the following reasons in her grounds of decision ( _Public Prosecutor v Pang Shuo_ <span class="citation">[2015] SGDC 308</span> (“the GD”)) for her sentencing with regard to the charge of unloading duty unpaid cigarettes under s 128H of the Customs Act: 
...
14     The courts must be cognisant of the legislative intention when developing appropriate sentencing frameworks for statutory offences. Sundaresh Menon CJ’s remarks at [27] of _Mehra Radhika v Public Prosecutor_ <span class="citation">[2015] 1 SLR 96</span> (“ _Mehra Radhika_ ”) are instructive: 
...
27     As Yong Pung How CJ in _Abu Syeed Chowdhury v Public Prosecutor_ <span class="citation">[2002] 1 SLR(R) 182</span> at [15] puts it: 
...
29     Many judgments have recently laid out comprehensive sentencing frameworks and benchmarks for various offences: _eg_ drink driving offences in _Edwin s/o Suse Nathen v Public Prosecutor_ <span class="citation">[2013] 4 SLR 1139</span>; offences under ss 140(1)(b) and (d), 146, 147 and 148 of the Women’s Charter (Cap 353, 2009 Rev Ed) in _Poh Boon Kiat v Public Prosecutor_ <span class="citation">[2014] 4 SLR 892</span>; s 49( _c_ ) Trade Marks Act (Cap 332, 2005 Rev Ed) offences in _Goik Soon Guan v Public Prosecutor_ <span class="citation">[2015] 2 SLR 655</span> (“ _Goik Soon Guan_ ”); and diamorphine trafficking offences in _Vasentha d/o Joseph v Public Prosecutor_ [2015] 5 SLR 
...
31     Apart from my previous observations in _Public Prosecutor v Chow Chian Yow Joseph Brian_ <span class="citation">[2016] 2 SLR 335</span> at [42]–[46] on the development of benchmark sentences, I also further note that the framework should seek to capture the cases that make up the bulk of everyday sentencing practice, with room for departure for justice by allowing for upward and downward adjustments based on each particular case’s facts and circumstances. For practical purposes and utility, the standard case should thus be analysed and set as the _typical_ offender and situation for the particular offence, having regard also to the observations of cases that come before the courts. Where possible, quantitative sentencing data should be employed to aid the development of the framework for greater rigour. The following principles should also be kept in mind: 
 ...
 the case at hand ( ie where within the available range does the offender’s conduct fall: see Public Prosecutor v Kwong Kok Hing <span class="citation">[2008] 2 SLR(R) 684</span> at [44]), and thus give effect to the legislated maximum and/or minimum sentences. 
...
36     In _Moey Keng Kong v Public Prosecutor_ <span class="citation">[2001] 2 SLR(R) 867</span> (“ _Moey Keng Kong_ ”), Yong CJ identified at [10] five significant factors relevant to sentencing for customs offences under s 130(1) ( _a_ ) of the Customs Act 1995 (in relation to a case of importation of uncustomed cigars hidden in a vehicle): 
