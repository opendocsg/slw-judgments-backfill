<span style="background-color: #FAC0C0"># Ong & Ong Architects Pte Ltd and Another v Yee Wei Chi and Another 
...
21     There has been no decision on this novel issue thus far. The amendments which the plaintiff made were essentially to add the second plaintiff to the action. Defendants’ counsel has relied on Andrew Ang J’s decision in _Vestwin Trading Pte Ltd v Obegi Melissa_ [[2006] 3 SLR 573]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> to submit that in a single action with multiple parties, pleadings would close against each defendant on the same date. 
