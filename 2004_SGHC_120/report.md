...
23     The Prosecution has submitted that this is an appropriate case for preventive detention in view of the accused’s antecedents. In _PP v Wong Wing Hung_ <span style="background-color: #FAC0C0" class="citation">[[1999] 4 SLR 329]("https://www.open.gov.sg")</span> at [9], Yong Pung How CJ succinctly summarised the underlying rationale for imposing preventive detention: 
...
In _PP v Perumal s/o Suppiah_ <span style="background-color: #FAC0C0" class="citation">[[2000] 3 SLR 308]("https://www.open.gov.sg")</span> at [40] and [41], the learned Chief Justice further observed that the issue to be considered is: 
