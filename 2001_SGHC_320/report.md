...
The Court of Appeal in **Leo Teng Choy v Leo Teng Kit** <span style="background-color: #FAC0C0" class="citation">[[2001] 1 SLR 256]("https://www.open.gov.sg")</span> has held (at [para ]22) that s 56 of the TA does not confer powers on the trustees. Instead it confers powers on the court to make the orders sought and is therefore not subject to s 2(2) of the TA which reads: 
