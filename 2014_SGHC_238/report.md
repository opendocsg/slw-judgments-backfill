...
30     Second, notwithstanding the above, the Presumption is a rebuttable one: _Public Prosecutor v Ng Guan Hup_ <span style="background-color: #FAC0C0" class="citation">[[2009] 4 SLR(R) 314]("https://www.open.gov.sg")</span> at [31]. Neither is it disputed that the _ejusdem generis_ rule may be displaced by the context. 

31     Both these propositions were relied upon in the High Court case of _Azman bin Jamaludin v PP_ <span style="background-color: #FAC0C0" class="citation">[[2012] 1 SLR 615]("https://www.open.gov.sg")</span> (“ _Azman_ ”), where the court considered whether s 263 of the CPC 1985 (set out at [10] above) could apply to interlocutory orders. 
