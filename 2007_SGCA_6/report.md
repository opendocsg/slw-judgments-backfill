...
70     In _De Montfort University v Stanford Training Systems Pte Ltd_ <span class="citation">[2006] 1 SLR 218</span>, the High Court stayed a winding-up petition which was presented before the company commenced an action against the creditor claiming an unliquidated sum, applying the Privy Council’s statement in _Malayan Plant._ Tay J held that in the light of the alleged counterclaim, the debt was disputed on substantial grounds and it could not be ascertained whether the petitioner’s alleged debt would exceed the statutory minimum of S$10,000 provided for under s 254(2)( _a_ ) of the Act in order to make the winding up order. 
