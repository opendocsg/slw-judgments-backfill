<span style="background-color: #FAC0C0"># Public Prosecutor v Siva Raman 
...
If the prosecution is able to invoke the presumption of knowledge, an accused must prove, on a balance of probabilities, that he did not have knowledge of the nature of the drug: _Obeng Comfort v Public Prosecutor_ [[2017] 1 SLR 633]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [37]. 
...
34     On the first requirement, the Court of Appeal in _Public Prosecutor v Chum Tat Suan and another_ [[2015] 1 SLR 834]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [63], observed that as recognised in the High Court case of _Public Prosecutor v Abdul Haleem bin Abdul Karim and another_ [[2013] 3 SLR 734]("https://www.open.gov.sg")</span> at [51], the definition of a courier in s 33B(2)( _a_ ) is a narrow one. In that case, the High Court concluded that a courier is one whose involvement is limited to delivering or conveying drugs from point A to point B. 
