<span style="background-color: #FAC0C0"># BDC v BDD 
...
5       The principles governing leave to appeal in such cases were laid down by the Court of Appeal in _IW v IX_ [[2006] 1 SLR(R) 135]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [10]-[24]. This case similarly concerned a custody dispute under Part X of the Women’s Charter. The appellate court re-affirmed the guidelines set out in _Lee Kuan Yew v Tang Liang Hong_ [[1997] 2 SLR(R) 862]("https://www.open.gov.sg")</span> (“ _Lee Kuan Yew v Tang Liang Hong_ ”) at [16], which held that there are at least three limbs which can be relied upon when leave to appeal is sought, _viz_ : 
