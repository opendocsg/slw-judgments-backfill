...
119    Recently, Chief Justice Sundaresh Menon in _Public Prosecutor v Hue An Li_ <span style="background-color: #FAC0C0">[[2014] 4 SLR 661]("https://www.open.gov.sg")</span> (“ _Hue An Li_ ”) also recognised the conceptual difference between rashness and negligence (at [45]): 
...
159    In a different context, Rajah J (as he then was) also commented as follows in _Public Prosecutor v Law Aik Meng_ <span style="background-color: #FAC0C0">[[2007] 2 SLR(R) 814]("https://www.open.gov.sg")</span> (at [22]): 
