<span style="background-color: #FAC0C0"># Sivakumar s/o Selvarajah v Public Prosecutor 
...
64     It is trite law that an appellate court will not disturb the sentence imposed by the trial court unless it is satisfied that (a) the judge erred with respect to the proper factual basis for sentencing; (b) the judge failed to appreciate the materials placed before him; (c) the sentence was wrong in principle; or (d) the sentence was manifestly excessive or inadequate, as the case may be: _Public Prosecutor v UI_ [[2008] 4 SLR(R) 500]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [12]. 
