...
42     As the Court of Appeal observed in _Tan Chin Seng v Raffles Town Club_ <span style="background-color: #FAC0C0" class="citation">[[2002] 2 SLR(R) 465]("https://www.open.gov.sg")</span> at [17] and [19]: 
...
Hence, if the documents sought are relevant but not necessary for the fair adjudication of the dispute or to save costs, the court will not order discovery of such documents. Necessity is the key to discovery (see also _Ting Kang Chung John v Teo Hee Lai Building Construction Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2008] SGHC 54]("https://www.open.gov.sg")</span>). 
...
50     In _Soh Lup Chee & Ors v Seow Boon Cheng & Anor_ <span style="background-color: #FAC0C0" class="citation">[[2002] 1 SLR(R) 604]("https://www.open.gov.sg")</span> (“ _Soh Lup Chee_ ”) at [9], the High Court remarked that generally, affidavits verifying lists of documents could not be 
