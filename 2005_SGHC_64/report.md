...
A sentence of life imprisonment is justified if the answers to these three considerations are affirmative (see _Neo Man Lee v PP_ [1991] SLR 146, _PP v Ong Wee Teck_ <span style="background-color: #FAC0C0">[[2001] 3 SLR 479]("https://www.open.gov.sg")</span> and _PP v Kwok Teng Soon_ <span style="background-color: #FAC0C0">[[2001] 4 SLR 516]("https://www.open.gov.sg")</span>). Caning is not imposed in such cases as the accused persons would have been suffering from such abnormality of mind as would have substantially impaired their mental responsibility for their acts. 
