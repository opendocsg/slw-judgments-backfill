<span style="background-color: #FAC0C0"># Poh Choon Kia and another v Lim Hoe Heng and another 
...
the following grounds: 
 ...
 (b) The caveat effectively operated as a statutory injunction ( Alrich Development Pte Ltd v Rafiq Jumabhoy [[1993] 1 SLR(R) 598]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">) and, based on a balance of convenience, an order to remove the caveat should be given ( Tan Yow Kon v Tan Swat Ping [[2006] 3 SLR(R) 881]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">). 
