...
the following grounds: 
 ...
 (b) The caveat effectively operated as a statutory injunction ( Alrich Development Pte Ltd v Rafiq Jumabhoy <span style="background-color: #FAC0C0" class="citation">[[1993] 1 SLR(R) 598]("https://www.open.gov.sg")</span>) and, based on a balance of convenience, an order to remove the caveat should be given ( Tan Yow Kon v Tan Swat Ping <span style="background-color: #FAC0C0" class="citation">[[2006] 3 SLR(R) 881]("https://www.open.gov.sg")</span>). 
