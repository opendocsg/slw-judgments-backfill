...
16     Another decision of the Court of Appeal, _The “Melati”_ <span style="background-color: #FAC0C0" class="citation">[[2004] 4 SLR 7]("https://www.open.gov.sg")</span>, is more helpful. In this case, the Court considered an argument that the filing of a statement of claim could not be a step under r 2(6) because the filing of a statement of claim, without it being served, did not move a case forward. The Court rejected the argument. It stated in its judgment that: 
