<span style="background-color: #FAC0C0"># Balanalagirisamy Gowri Rajeswari and another (administrators of the estate of Radhakrishnan 
...
12     The use of different multiplicands is not unprecedented. In _See Soon Soon v Goh Yong Kwang_ [[1992] 2 SLR 242]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _See Soon Soon_ ”), Chan Sek Keong J split the multiplier of 15 years into one period of five years and one period of 10 years and applied a different multiplicand for each period (at [35]). For the first period of five years, he applied the mean of $3,000 and $6,700, _ie_ , $4,850 ( _id_ at [36]). For the second period of five years, he applied the median of $20,000 and $30,000, _ie,_ $15,000 ( _id_ at [36]). The multiplicand for the second period was based on evidence of what the deceased, who was a medical officer, would have earned if he was promoted and was able to enhance his earnings from consultancy work ( _id_ at [33]–[34]). 

13     The approach in _See Soon Soon_ was applied by Judith Prakash JC in the case of _Lim Fook Lau v Kepdrill International Incorporated SA_ [[1993] 1 SLR 917]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">. In that case, Prakash JC similarly applied two multiplicands. In doing so, she stated ( _id_ at [11]): 
...
14     In the recent case of _Ramesh s/o Ayakanno v Chua Gim Hock_ [[2008] SGHC 33]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, Kan J upheld the decision of the assistant registrar to apply three separate multiplicands over three different periods. In doing so, he stated (at [43]): 
