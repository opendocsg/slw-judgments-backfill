...
1       This is an appeal against the decision of Lee Seiu Kin J (“the Judge”) in Originating Summons No 1727 of 2007, _viz_ , _Jurong Shipyard Pte Ltd v BNP Paribas_ <span style="background-color: #FAC0C0">[[2008] 4 SLR 33]("https://www.open.gov.sg")</span> (“the GD”) granting Jurong Shipyard Pte Ltd (“JSPL”) an injunction to restrain BNP Paribas (“BNP”) from commencing winding-up proceedings against JSPL, which BNP had threatened to do after JSPL had failed to comply with BNP’s statutory demand for payment of approximately US$50m allegedly due and payable by JSPL to BNP arising from certain foreign exchange contracts to which BNP was a counterparty. 
