<span style="background-color: #FAC0C0"># PC Connect Pte Ltd v HSBC Institutional Trust Services (Singapore) Ltd (trustee of CapitaMall 
...
42     There was another fundamental issue in the action in nuisance. This claim was for private nuisance affecting the plaintiff’s unit. The Court of Appeal had noted in _Epolar System Enterprises Pte Ltd and others v Lee Hock Chuan and others_ [[2003] 2 SLR(R) 198]("https://www.open.gov.sg")</span> at [10] that generally only a person with proprietary interest such as a freehold or leasehold interest can bring proceedings in private nuisance, and as a rule, occupation _per se_ will not suffice. 
