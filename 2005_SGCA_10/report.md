<span style="background-color: #FAC0C0"># Multiplex Constructions Pty Ltd v Sintal Enterprise Pte Ltd 
...
6       The parties are in substantial agreement on the legal principles that guide the court when it hears an application under s 6 of the Act. Both parties cited the decision in _Kwan Im Tong Chinese Temple v Fong Choon Hung Construction Pte Ltd_ [[1998] 2 SLR 137]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“the _Kwan Im Tong_ case”). There, while this court accepted the principle enunciated in _Tradax Internacional SA v Cerrahogullari TAS_ ( _The M Eregli_ ) [1981] 2 Lloyd’s Rep 169 that if the claim is indisputable then the court has jurisdiction to hear the matter instead of referring it to arbitration, it also sanctioned a holistic and common-sense approach towards determining the existence of a dispute. In so doing, this court adopted the following observation of G P Selvam JC (as he then was) in _Uni-Navigation Pte Ltd v Wei Loong Shipping Pte Ltd_ [[1993] 1 SLR 876]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at 879, [16] and [17]: 
...
11     Before we go to the judge’s findings (reported at [[2004] 4 SLR 841]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">), it would be helpful for the relevant contractual provisions to be set out. These are: 
