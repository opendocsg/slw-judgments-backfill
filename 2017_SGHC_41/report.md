...
payments were based on these measurements. [note: 92] The parties therefore “by the course of dealing, put their own interpretation on their contract, and cannot be allowed to go back on it” ( _China Construction (South Pacific) Development Co Pte Ltd v Spandeck Engineering (S) Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2005] SGHC 86]("https://www.open.gov.sg")</span> at [46], citing _Amalgamated Investment & Property Co Ltd v Texas Commerce International Bank_ 
...
always contractually subject to final re-measurement. This is so for the following reasons: [note: 95] 
 ...
 (d) The wall finishes subcontract is a re-measurement contract. This is not disputed by both parties. Hence, the interim certificates are subject to re-measurement ( LW Infrastructure Pte Ltd v Lim Chin San Contractors Pte Ltd <span style="background-color: #FAC0C0" class="citation">[[2011] 4 SLR 477]("https://www.open.gov.sg")</span> at [44]). [note: 96] They are of no consequence to the final amounts due under the wall finishes subcontract. 
...
95     The defendant argues that the present factual situation is similar to the case of _Hi-Amp Engineering Pte Ltd v Technicdelta Electrical Engineering Pte Ltd_ <span style="background-color: #FAC0C0" class="citation">[[2003] SGHC 316]("https://www.open.gov.sg")</span> (“ _Hi-Amp_ 
...
104    The defendant has not pleaded and did not submit that an alternative basis for its counterclaim was a _quantum meruit_. I cannot award compensation to the defendant on a cause of action which it has not pleaded ( _Ong Seow Pheng and others v Lotus Development Corp and another_ <span style="background-color: #FAC0C0" class="citation">[[1997] 2 SLR(R) 113]("https://www.open.gov.sg")</span> at [41]). 
