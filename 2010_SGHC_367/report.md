...
125    In _Chen Cheng v Central Christian Church_ <span style="background-color: #FAC0C0">[[1998] 3 SLR(R) 236]("https://www.open.gov.sg")</span> (“ _Chen Cheng_ ”), the Court of Appeal held that, to succeed in the defence of fair comment, a defendant must prove the following elements: 
...
127    In _Hytech Builders Pte Lte v Goh Teng Poh Karen_ <span style="background-color: #FAC0C0">[[2008] 3 SLR(R) 236]("https://www.open.gov.sg")</span>, the High Court concluded that the words “on the verge of collapse” were not comment and would be considered by an ordinary reasonable reader as an assertion of fact. 
