<span style="background-color: #FAC0C0"># Public Prosecutor v Yusry Shah bin Jamal 
...
2       I heard this appeal together with _PP v Mohammad Al-Ansari bin Basri_ [[2007] SGHC 187]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> (“ _Mohammad Al-Ansari bin Basri_ ”) and allowed the Prosecution’s appeal by substituting the probation order made by the district judge with a sentence of reformative training with immediate effect. As the applicable sentencing principles are largely identical with that discussed in my grounds of decision for _Mohammad Al-Ansari bin Basri_ , it will be sufficient for the purposes of the present appeal if I were simply to state the facts and refer to _Mohammad Al-Ansari bin Basri_ to explain the reasons for my decision here. 
...
17     Furthermore, the additional fact that the respondent committed a separate offence, while on court bail, showed further that probation was not appropriate. In _PP v Loqmanul Hakim bin Buang_ [[2007] SGHC 159]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, I had articulated the reason why an offence committed while on bail could be considered an aggravating feature (at [54]): 
