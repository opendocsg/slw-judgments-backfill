...
26     I came to the crucial question of whether the contested findings that the appellant did not disarm ‘Siva’ and _therefore_ was the offender seen by Balraju were ‘plainly wrong’ or ‘against the weight of evidence’. I was fully aware, as was the district judge below, of the difficulties in the prosecution’s case. Having accepted Balraju’s version of events as the truth, the district judge made the conclusion that the appellant was the offender seen by Balraju. This conclusion was an inference which the appellate court is in as good a position to make as the trial judge: _Awtar Singh s/o Margar Singh v PP_ <span style="background-color: #FAC0C0" class="citation">[[2000] 3 SLR 439]("https://www.open.gov.sg")</span>. 
