...
7       There are three requirements under s 4(8): the assignment must be absolute and not by way of charge only; it must be in writing under the hand of the assignor; and express notice in writing must be given to the person liable to the assignor under the assigned chose in action. In _Salim Anthony v Sumitomo Corp Capital Asia Pte Ltd_ (“ _Salim Anthony_ ”) <span style="background-color: #FAC0C0" class="citation">[[2004] 3 SLR 331]("https://www.open.gov.sg")</span>, Lai Siu Chiu J considered what constitutes notice of assignment and affirmed the authorities cited to her at [91]–[92]: 
...
12     As for equitable assignments, there is no requirement of notice to the debtor or even the assignee; what must be shown is a manifestation of the assignor’s intention to assign (see _Tsu Soo Sin v Oei Tjiong Bin_ <span style="background-color: #FAC0C0" class="citation">[[2008] SGCA 46]("https://www.open.gov.sg")</span>). I will return to the legal tests in considering the validity of the first and second assignments in law or equity below. 
