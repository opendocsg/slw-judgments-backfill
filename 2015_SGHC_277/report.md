...
26     The threshold for appellate review in an appeal against a sentence is trite (see _Public Prosecutor v Kwong Kok Hing_ <span style="background-color: #FAC0C0">[[2008] 2 SLR(R) 684]("https://www.open.gov.sg")</span> at [14]). The appellate court must be satisfied that the sentencing judge had: 
