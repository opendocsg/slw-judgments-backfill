<span style="background-color: #FAC0C0"># Zhou Tong and others v Public Prosecutor 
...
15     In particular, I made the following general observations on the standard of care and skill required of solicitors in the decision of _Lie Hendri Rusli v Wong Tan & Molly Lim (a firm)_ [[2004] 4 SLR(R) 594]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0">, at [42]–[44]: 
...
While the court in _Ridehalgh_ approved of the three-stage test, the “overarching rule with regard to ordering costs against a non-party in court proceedings is that it must, in the circumstances of the case, be _just_ to do so”: see _DB Trustees (Hong Kong) Ltd v Consult Asia Pte Ltd and another_ [[2010] SGCA 21]("https://www.open.gov.sg")</span><span style="background-color: #FAC0C0"> at [29]. The other two stages may be considered as relevant factors in ascertaining where the overall balance of justice lies. 
